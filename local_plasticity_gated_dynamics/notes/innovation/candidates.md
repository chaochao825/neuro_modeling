...
|---|---|---|---|---|---|
| I1 | Causal, reward-trained selection among routing, fast-memory, and temporal motifs for personalized ORBIT recognition | Existing ORBIT methods emphasize prototype/meta-learning, sampling, or parameter adaptation; fast-weight models usually evaluate language/retrieval rather than cross-user video personalization | Official CLU-VE, held-out users, fixed-best and strong few-shot baselines, causal interventions | Backbone dominance; correlated actions; only 17 test users | selected |
