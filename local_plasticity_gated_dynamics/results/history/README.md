...
| exp43 Fast-slow causal decomposition probe | uncertainty_control | `historical_only` | **mixed** | none | [exp43_fast_slow_causal_decomposition_development_20260728.md](../history/exp43_fast_slow_causal_decomposition_development_20260728.md) |
| exp44 Piray-Daw Q/R behavioral utility | real_behavior | `historical_only` | **oppose** | none | [report.md](../exp44_piray_daw_qr_behavior_development_v1/report.md) |
