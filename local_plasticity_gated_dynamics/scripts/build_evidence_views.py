...
def build_views(project_root: Path, output_root: Path | None = None) -> None:
    ...
    current_lines = [
        ...
        "factorized-uncertainty composition result. Exp44 is an open prospective",
        "real-behavior protocol and has no result row yet. Superseded prefix, change-point,",
        ...
        "remains fail-closed and inconclusive. Exp44 authorizes Experiment-1",
        "development only; its Experiment-2 and POPGym stages remain locked.",
        "",
