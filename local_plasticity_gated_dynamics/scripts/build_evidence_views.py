...
def build_views(project_root: Path, output_root: Path | None = None) -> None:
    ...
    current_lines = [
        ...
        "scalar-retention, and failed real-behavior methods live only in the historical view.",
        "",
        ...
        "remains fail-closed and inconclusive. Exp44 failed its Experiment-1",
        "development gate; its Experiment-2 and POPGym stages remain unexecuted.",
        "",
    ...
    history_lines = [
        ...
        "The Exp43 fast/slow exchange audit is summarized in",
        "`exp43_fast_slow_causal_decomposition_development_20260728.md`; it",
        "preserves oracle headroom in both inference paths, the failed deployable",
        "conjunction, and the decision not to access its reserved formal seeds.",
        "The Exp44 Piray--Daw audit is summarized in",
        "`exp44_piray_daw_behavioral_utility_development_20260730.md`; it",
        "preserves the failed participant-held utility gate, the positive post-hoc",
        "human Q/R modulation check, and the locks on Experiment 2 and POPGym.",
        "",
